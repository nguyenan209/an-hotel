...
export default function ApprovalDetailPage({ params }: ApprovalDetailPageProps) {
  ...
  const homestay = {
    ...
    maxGuests: 8,
    totalRooms: 4,
    amenities: ["Wifi", "Bể bơi", "Bếp", "Máy lạnh", "Bãi đỗ xe", "TV", "Máy giặt", "Ban công", "BBQ", "Sân vườn"],
    images: [
    ...
    rooms: [
      {
        id: "room1",
        name: "Master Suite",
        description: "Spacious master bedroom with en-suite bathroom and ocean view",
        price: 1000000,
        capacity: 2,
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Submitted by{" "}
            <Link href={`/admin/owners/${homestay.owner.id}`} className="text-blue-600 hover:underline">
              {homestay.owner.name}
            </Link>{" "}
        ...
        <TabsContent value="details" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Review the basic details of the homestay.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  <p className="text-base">{homestay.price.toLocaleString()} VND</p>
                </div>
                <div>
                  <h3 className="text-sm font-medium text-muted-foreground">Maximum Guests</h3>
        ...
        <TabsContent value="rooms" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Review the rooms available in this homestay.</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {homestay.rooms.map((room) => (
                  <div key={room.id} className="rounded-lg border p-4">
                    ...
                    <div className="mt-2 flex justify-between">
                      <span className="text-sm font-medium">{room.price.toLocaleString()} VND / night</span>
        ...
        <TabsContent value="images" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Review the images uploaded for this homestay.</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="owner" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Review the details of the homestay owner.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                ...
                <div>
                  ...
                  <p className="text-base">{formatDate(homestay.owner.joinDate)}</p>
                </div>
                <div>
                  <h3 className="text-sm font-medium text-muted-foreground">Status</h3>
                  <Badge
                    className={
                      homestay.owner.status === "active" ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                    }
                  >
                    {homestay.owner.status.charAt(0).toUpperCase() + homestay.owner.status.slice(1)}
                  </Badge>
                </div>
              </div>
            </CardContent>
      ...
      {status === "pending" && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Approve or reject this homestay listing.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div>

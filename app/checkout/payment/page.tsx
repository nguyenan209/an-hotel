...
export default function PaymentPage() {
  ...
  const [paymentMethod, setPaymentMethod] = useState<"qr_code" | "reception">(
    "qr_code"
  );
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="border rounded-lg p-6 shadow-sm">
            ...
            <RadioGroup
              value={paymentMethod}
              onValueChange={(value) =>
                setPaymentMethod(value as "qr_code" | "reception")
              }
              className="space-y-4"
            >
              <div
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 flex-1">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Quét mã QR bằng ứng dụng ngân hàng hoặc ví điện tử để
                      thanh toán
                    </p>

                    {paymentMethod === "qr_code" && (
                      <QrCodePayment amount={totalPrice} className="mt-4" />
                    )}
                  </div>
                </div>
              </div>

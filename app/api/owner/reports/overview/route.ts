...
export async function GET(req: NextRequest) {
  try {
    ...
    // Tổng doanh thu: chỉ tính payment của các booking thuộc homestay của owner này
    ...
    // Tổng số bookings: chỉ đếm booking thuộc homestay của owner này
    ...
    // Điểm rating trung bình: chỉ tính review của homestay thuộc owner này
